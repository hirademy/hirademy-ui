...
function applyForSWInternship() {
  window.location.href = "https://forms.gle/UYomE1vbUBe6B6gZA";
}

// Function to open the same URL
function applyForOtherInternship() {
  window.location.href = "https://forms.gle/GECPJcYXP7fRMqy69";
}
